...
folder<-paste("/Volumes/HELIOS/SST_CMC0.2deg_NZ/data/", sep="")
...
times<-times[,c("Unix", "jday", "Temp")]


outfile<-paste("/Volumes/HELIOS/SST_CMC0.2deg_NZ/EReef/",filenames[i], sep="")

outfile<-gsub(".nc", "_NZ_EReef.txt", outfile)
